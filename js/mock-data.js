...
window.MAYDAN_MOCK = {
  ...
  students: [
    ...
    },
    {
      ...
      projects: [
        { name: "Microprocessor Logic Simulator", desc: "محاكي منطقي للمعالجات والرقائق المعالجة بلغة Verilog و C++" },
        { name: "Embedded Smart Sensors Platform", desc: "نظام مدمج لقراءة وتحليل الحساسات الرقمية بالقصيم" }
      ],
    ...
    },
    {
      ...
      projects: [
        { name: "Interactive Web Portal", desc: "منصة تفاعلية عالية السلاسة لإدارة التفاعلات والمستندات الرقمية" }
      ],
    ...
    },
    {
      ...
      projects: [
        { name: "Secure Chip Verification Logic", desc: "منطق واختبار سلامة الرقائق والمعالجات الإلكترونية لمنع الاختراق" }
      ],
    ...
    },
    {
      ...
      projects: [
        { name: "AI Customer Support Assistant", desc: "مساعد ذكي للإجابة على استفسارات العملاء باللغة العربية" }
      ],
